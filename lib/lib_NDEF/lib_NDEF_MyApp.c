...
static void NDEF_Extract_M24SRDiscoveryApp_Input ( struct sRecordInfo *pRecordStruct, sMyAppInfo *pMyAppStruct );
...
/**
  ...
  */
uint16_t NDEF_ReadMyApp(struct sRecordInfo *pRecordStruct, sMyAppInfo *pMyAppStruct)
{
